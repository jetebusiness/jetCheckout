...
;(function ($, window, document, undefined) {
    ...
    var pluginName = "jetCheckout",
        ...
        validate: {
            ...
            date: {
                type: "regex",
                pattern: /(((0[1-9]|[12][0-9])|3[01])[\x2D\/](0[13578]|1[02])[\x2D\/][1-9][0-9][0-9][0-9])|(((0[1-9]|[12][0-9])|30)[\x2D\/](0[13-9]|1[0-2])[\x2D\/][1-9][0-9][0-9][0-9])|((0[1-9]|[12][0-9])[\x2D\/]02[\x2D\/][1-9][0-9]([02468][048]|[13579][26]))|((0[1-9]|[12][0-8])[\x2D\/]02[\x2D\/][1-9][0-9][0-9][0-9])/,
            ...
            phone: {
                type: "regex",
                pattern: /(^|\()?[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*([0-9]{2})[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*([\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]|\))*(9?[0-9]{4})([\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]|\x2D)?([0-9]{4})($|\n)/,
